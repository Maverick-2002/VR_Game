...
public class GunScriptableObject : ScriptableObject
{
    ...
    public void Spawn(Transform Parent, MonoBehaviour ActiveMonoBehaviour)
    {
        ...
        LastShootTime = 0; //in editor it will not reset but in build it's fine
    ...
    public void Shoot()
    {
        if(Time.time > ShootConfig.FireRate + LastShootTime)
        {
            ...
            {
                ActiveMonoBehaviour.StartCoroutine( PlayTrail(ShootSystem.transform.position, ShootSystem.transform.position 
